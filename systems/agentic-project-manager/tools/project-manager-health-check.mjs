...
const knowledge = ["knowledge-registry.json","knowledge-blob-template.md","skill-knowledge-audit.md","capability-orchestration/capability-radar-trigger-policy.blob.md","capability-orchestration/trigger-policy.blob.md","capability-orchestration/knowledge-blob-policy.blob.md","capability-orchestration/micro-update-policy.blob.md","capability-orchestration/new-skill-vs-blob-policy.blob.md","routing/codebase-intelligence-routing.blob.md"];
