...
const tools = ["project-manager-health-check.mjs","pm-init-task.mjs","pm-classify-task.mjs","pm-create-roadmap.mjs","pm-next-packet.mjs","pm-log-execution.mjs","pm-log-verification.mjs","pm-log-tool-usage.mjs","pm-log-inefficiency.mjs","pm-log-user-response.mjs","pm-log-error.mjs","pm-review-errors.mjs","pm-promote-lesson.mjs","pm-suggest-skill-update.mjs","pm-learning-report.mjs","pm-completion-report.mjs","pm-archive-task.mjs","pm-capability-sync.mjs","pm-improvement-review.mjs","pm-knowledge-lookup.mjs","pm-knowledge-register.mjs","pm-knowledge-gap.mjs","pm-knowledge-index.mjs","pm-knowledge-search.mjs","pm-knowledge-related.mjs","pm-knowledge-dedupe.mjs","pm-pack-init.mjs","pm-pack-audit.mjs","pm-pack-promote.mjs"];
...
const knowledge = ["knowledge-registry.json","knowledge-blob-template.md","skill-knowledge-audit.md","retrieval-tool-evaluation.md","retrieval-audit.md","retrieval-policy.md","knowledge-product-policy.md","naming-ontology-policy.md","pack-builder-workflow.md","capability-orchestration/capability-radar-trigger-policy.blob.md","capability-orchestration/trigger-policy.blob.md","capability-orchestration/knowledge-blob-policy.blob.md","capability-orchestration/micro-update-policy.blob.md","capability-orchestration/new-skill-vs-blob-policy.blob.md","routing/codebase-intelligence-routing.blob.md"];
